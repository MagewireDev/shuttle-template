...
import { o as mixinConstraintValidation, p as mixinFormAssociated, q as requestUpdateOnAriaChange, _ as __decorate, n, g as i, v as isActivationClick, w as dispatchActivationClick, x, y as o, h as A, j as redispatchEvent, z as getFormValue, C as getFormState, D as createValidator, E as CheckboxValidator, G as getValidityAnchor, H as mixinElementInternals, t as s, i as i$1, e } from './core.js';
...
const switchBaseClass = mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s)));
/**
...
class Switch extends switchBaseClass {
    ...
    render() {
        ...
        return x `
      <div class="switch ${o(this.getRenderClasses())}">
        <input
          id="switch"
          class="touch"
          type="checkbox"
